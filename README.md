...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create remix-indie-stack-blog-236e
  fly apps create remix-indie-stack-blog-236e-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-indie-stack-blog-236e
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-indie-stack-blog-236e-staging
  ```
...
- Create a persistent volume for the sqlite database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly volumes create data --size 1 --app remix-indie-stack-blog-236e
  fly volumes create data --size 1 --app remix-indie-stack-blog-236e-staging
  ```
